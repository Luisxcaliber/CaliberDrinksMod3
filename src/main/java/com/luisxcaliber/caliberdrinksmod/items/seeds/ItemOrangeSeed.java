...
public class ItemOrangeSeed extends Item implements IPlantable 
{
	public ItemOrangeSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.ORANGE_PLANT.getDefaultState());
            stack.shrink(1);
	...
	{
		return ModBlocks.ORANGE_PLANT.getDefaultState();
	}
}
