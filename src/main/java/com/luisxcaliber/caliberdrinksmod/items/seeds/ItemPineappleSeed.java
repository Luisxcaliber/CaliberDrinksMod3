...
public class ItemPineappleSeed extends Item implements IPlantable 
{
	public ItemPineappleSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.PINEAPPLE_PLANT.getDefaultState());
            stack.shrink(1);
