...
public class ItemMangoSeed extends Item implements IPlantable 
{
	public ItemMangoSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.MANGO_PLANT.getDefaultState());
            stack.shrink(1);
	...
	{
		return ModBlocks.MANGO_PLANT.getDefaultState();
	}
}
