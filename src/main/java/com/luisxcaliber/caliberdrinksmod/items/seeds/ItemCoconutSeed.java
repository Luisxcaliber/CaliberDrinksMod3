...
public class ItemCoconutSeed extends Item implements IPlantable 
{
	public ItemCoconutSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.COCONUT_PLANT.getDefaultState());
            stack.shrink(1);
	...
	{
		return ModBlocks.COCONUT_PLANT.getDefaultState();
	}
}
