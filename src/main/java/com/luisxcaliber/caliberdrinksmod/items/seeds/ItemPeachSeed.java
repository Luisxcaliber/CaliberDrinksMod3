...
public class ItemPeachSeed extends Item implements IPlantable 
{
	public ItemPeachSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.PEACH_PLANT.getDefaultState());
            stack.shrink(1);
	...
	{
		return ModBlocks.PEACH_PLANT.getDefaultState();
	}
}
