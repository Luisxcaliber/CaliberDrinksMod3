...
public class ItemPomegranateSeed extends Item implements IPlantable 
{
	public ItemPomegranateSeed(String name) 
	{
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), ModBlocks.POMEGRANATE_PLANT.getDefaultState());
            stack.shrink(1);
	...
	{
		return ModBlocks.POMEGRANATE_PLANT.getDefaultState();
	}
}
